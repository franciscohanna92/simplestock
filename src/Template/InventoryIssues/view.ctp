...
<div class="card">
    <div class="card-body">
                <table class="vertical-table">
                            ...
                            <td><?= $inventoryIssue->has('employee') ? $this->Html->link($inventoryIssue
                                ->employee->name, ['controller' =>
                                'Employees', 'action' => 'view', $inventoryIssue->employee
                                ->id]) : '' ?>
                            </td>
                        </tr>
                                                                                                        <tr>
                            <th scope="row"><?= __('Building Site') ?></th>
                            <td><?= $inventoryIssue->has('building_site') ? $this->Html->link($inventoryIssue
                                ->building_site->name, ['controller' =>
                                'BuildingSites', 'action' => 'view', $inventoryIssue->building_site
                                ->id]) : '' ?>
                            </td>
                        </tr>
                                                                                                        <tr>
                            <th scope="row"><?= __('Company') ?></th>
                            <td><?= $inventoryIssue->has('company') ? $this->Html->link($inventoryIssue
                                ->company->name, ['controller' =>
                                'Companies', 'action' => 'view', $inventoryIssue->company
                                ->id]) : '' ?>
                            </td>
                        </tr>
                                                                                                            <tr>
                        ...
                        <td><?= $this->Number->format($inventoryIssue->created_by) ?></td>
                    </tr>
                                    <tr>
                        <th scope="row"><?= __('Updated By') ?></th>
                        <td><?= $this->Number->format($inventoryIssue->updated_by) ?></td>
                    </tr>
                                                                            <tr>
                        ...
                        <td><?= h($inventoryIssue->created_at) ?></td>
                    </tr>
                                    <tr>
                        <th scope="row"><?= __('Updated At') ?></th>
                        <td><?= h($inventoryIssue->updated_at) ?></td>
                    </tr>
                                                </table>
                                                            <div class="related">
                <h4><?= __('Related Articles') ?></h4>
                <?php if (!empty($inventoryIssue->articles)): ?>
                <table cellpadding="0" cellspacing="0">
                    ...
                    <?php foreach ($inventoryIssue->articles as $articles): ?>
                    <tr>
                                                    <td><?= h($articles->id) ?></td>
