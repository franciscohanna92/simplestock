...
<div class="card card-default">
    <div class="card-body row">
                ...
                </div>                            <div class="col-12 col-md-6 col-lg-4">                            <?php echo   $this->BootsCakeForm->control('surname', ['required' => false]); ?>
                </div>                            <div class="col-12 col-md-6 col-lg-4">                            <?php echo   $this->BootsCakeForm->control('cuil', ['required' => false]); ?>
                ...
                </div>                            <div class="col-12 col-md-6 col-lg-4">                            <?php echo   $this->BootsCakeForm->control('position', ['required' => false]); ?>
