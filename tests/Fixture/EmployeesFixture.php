...
class EmployeesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'dni' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'observations' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'employees_ibfk_1' => ['type' => 'foreign', 'columns' => ['building_site_id'], 'references' => ['building_sites', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'company_id' => 1,
                'building_site_id' => 1,
                'created_at' => 1568682563,
                'updated_by' => 1,
                'created_by' => 1,
                'updated_at' => 1568682563
            ],
        ];
        parent::init();
    }
