...
/**
 * InventoryReceiptsFixture
 *
 */
class InventoryReceiptsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'descriptive_name' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'inventory_receipts_ibfk_1' => ['type' => 'foreign', 'columns' => ['providers_id'], 'references' => ['providers', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'providers_id' => 1,
                'company_id' => 1,
                'created_at' => 1567653602,
                'created_by' => 1,
                'updated_at' => 1567653602,
                'updated_by' => 1
            ],
        ];
        parent::init();
