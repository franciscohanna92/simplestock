...
class InventoryReceiptsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_inventory_receipts_providers1_idx' => ['type' => 'index', 'columns' => ['providers_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_inventory_receipts_providers1' => ['type' => 'foreign', 'columns' => ['providers_id'], 'references' => ['providers', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'providers_id' => 1,
                'company_id' => 1,
                'created_at' => 1562986563,
                'created_by' => 1,
                'updated_at' => 1562986563,
                'updated_by' => 1
            ],
        ];
        parent::init();
