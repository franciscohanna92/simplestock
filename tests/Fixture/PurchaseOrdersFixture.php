...
class PurchaseOrdersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'date' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_purchase_orders_providers1_idx' => ['type' => 'index', 'columns' => ['provider_id'], 'length' => []],
            'fk_purchase_orders_purchase_orders_statuses1_idx' => ['type' => 'index', 'columns' => ['status_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_purchase_orders_providers1' => ['type' => 'foreign', 'columns' => ['provider_id'], 'references' => ['providers', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_purchase_orders_purchase_orders_statuses1' => ['type' => 'foreign', 'columns' => ['status_id'], 'references' => ['purchase_orders_statuses', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status_id' => 1,
                'company_id' => 1,
                'created_at' => 1562986544,
                'created_by' => 1,
                'updated_at' => 1562986544,
                'updated_by' => 1
            ],
        ];
        parent::init();
