...
class ProvidersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cuit' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_providers_cities1_idx' => ['type' => 'index', 'columns' => ['city_id'], 'length' => []],
            'fk_providers_provinces1' => ['type' => 'index', 'columns' => ['province_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_providers_cities1' => ['type' => 'foreign', 'columns' => ['city_id'], 'references' => ['cities', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'city_id' => 1,
                'company_id' => 1,
                'created_at' => 1562987901,
                'created_by' => 1,
                'updated_at' => 1562987901,
                'updated_by' => 1,
                'province_id' => 1
            ],
        ];
