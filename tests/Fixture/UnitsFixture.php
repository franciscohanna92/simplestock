...
class UnitsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'abbreviation' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'identity' => ['type' => 'unique', 'columns' => ['id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_by' => 1,
                'updated_by' => 1,
                'created_at' => 1565929027,
                'updated_at' => 1565929027
            ],
        ];
        parent::init();
    }
