...
class InventoryIssuesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'building_site_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'fk_inventory_issues_building_sites1_idx' => ['type' => 'index', 'columns' => ['building_site_id'], 'length' => []],
            'fk_inventory_issues_employees1_idx' => ['type' => 'index', 'columns' => ['employee_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_inventory_issues_building_sites1' => ['type' => 'foreign', 'columns' => ['building_site_id'], 'references' => ['building_sites', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_inventory_issues_employees1' => ['type' => 'foreign', 'columns' => ['employee_id'], 'references' => ['employees', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'building_site_id' => 1,
                'company_id' => 1,
                'created_at' => 1562986555,
                'created_by' => 1,
                'updated_at' => 1562986555,
                'updated_by' => 1
            ],
        ];
        parent::init();
